...
public class AbstractFactoryTest {
    ...
    void dawn_delivery_should_be_packaged_in_hermal_box() {
        PackingClient dawnDeliveryPackingClient = new PackingClient(DeliveryPackingFactory.forDawn());
        PackingClient nextDayDeliveryPackingClient = new PackingClient(DeliveryPackingFactory.forNextDay());
